 ...
 * Cuando la JTable llame al metodo getTableCellRendererComponent, devolvera una ProgressBar con el porcentaje adecuado y ser� "impreso" en la celda correspondiente
 * La JTable le llamar� con el valor que tiene que mostrar, tal y como lo ha recibido del TableModel.
 *
